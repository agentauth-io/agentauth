...
import { CheckCircle, XCircle, TrendingUp, DollarSign, Bot } from "lucide-react";

interface AnalyticsPageProps {
    // Add any dynamic props needed - for now using static demo data
}

const AUTHORIZATION_DATA = [65, 78, 52, 91, 84, 73, 95, 88, 76, 82, 69, 94];
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-[#111] border border-[#222] rounded-xl p-6">
                    ...
                    <div className="flex items-end gap-2 h-48">
                        {AUTHORIZATION_DATA.map((value, i) => (
