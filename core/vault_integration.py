...
class SecretMetadata:
    ...
    description: str
    rotation_period_hours: int | None = None
...
class VaultClient:
    ...
    def kv_get(self, path: str, version: int | None = None) -> VaultResponse:
        """Retrieve a secret."""
        self._check_access()
    ...
    def kv_delete(self, path: str, versions: list[int] | None = None) -> VaultResponse:
    ...
    def _get_transit_key(self, name: str, version: int) -> dict[str, Any] | None:
        key_path = f"transit/{name}"
