...
class ConsensusLog:
    ...
    def get(self, sequence_number: int) -> Optional[Dict[str, Any]]:
        return self.log.get(sequence_number)
    
    def get_state(self, sequence_number: int) -> Optional[ConsensusState]:
...
class ConsensusNode:
    ...
    def __init__(
        ...
        on_execute: Optional[Callable[[ConsensusRequest], Any]] = None,
    ):
...
_cluster: Optional[ConsensusCluster] = None
