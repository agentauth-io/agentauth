...
from .crypto import KeyManager, generate_id
from .policy import Policy, PolicyBuilder, PolicyDecision, PolicyEffect, PolicyEngine
from .tokens import (
    AuthorizationToken,
    TokenFlag,
    TokenGenerator,
...
class AuthorizationResponse:
    ...
    request_id: str
    authorized: bool
    token: str | None = None  # Base64 token if authorized
...
class AuthorizationEngine:
    ...
    def verify_token(self, token_b64: str) -> tuple[bool, AuthorizationToken | None, str]:
        """
...
if __name__ == "__main__":
    ...
    print("[+] Set daily limit to $500 for user_demo")
