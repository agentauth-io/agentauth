...
class MeshAuthenticator:
    ...
    def get_peer_identity(self, cert: CertificateInfo) -> ServiceIdentity | None:
...
class ZeroTrustPolicyEngine:
    ...
    ) -> tuple[bool, AuthorizationPolicy | None]:
        """
...
class ZeroTrustMesh:
    ...
    def get_service_certificate(self, spiffe_id: str) -> CertificateInfo | None:
